...
import com.orgPRO.BlogApplication.domain.dtos.ApiErrorResponse;
...
public class ErrorController {
    ...
    public ResponseEntity<ApiErrorResponse> handleIlleggalArgumentException(IllegalArgumentException e){
        ApiErrorResponse error = ApiErrorResponse.builder()
